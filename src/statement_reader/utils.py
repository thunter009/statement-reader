...
def is_csv_file_type(path: Path):
    """
    tests whether a supplied file path is a csv file
    """
    return str(path).lower().endswith('.csv')


def is_xlsx_file_type(path: Path):
    """
    tests whether a supplied file path is a excel file
    """
    return str(path).lower().endswith('.xlsx')


def is_xls_file_type(path: Path):
    """
    tests whether a supplied file path is a excel file
    """
